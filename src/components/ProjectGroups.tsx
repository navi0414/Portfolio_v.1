  ...
  return (
    <div className="h-[100%]">
      <div className={`ProjectCol ${Pops.className} grid grid-cols-1 gap-10 `}>
        <div className="ProjectGroup flex items-center justify-between my-20 mb-20 h-[100%]">
          <Fade
            className="imgHolder min-h-[400px] min-w-[400px] rounded-sm overflow-hidden"
            direction="right"
            duration={1000}
            triggerOnce={true}
          >
        ...
        <div className="ProjectGroup flex flex-row-reverse items-center justify-between my-20 mb-20 h-[100%]">
          <Fade
            className="imgHolder min-h-[400px] min-w-[400px] rounded-sm overflow-hidden"
            direction="left"
            duration={1000}
